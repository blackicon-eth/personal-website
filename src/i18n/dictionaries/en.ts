export const en = {
  metadata: {
    ...
    description:
      "Mattia Verdecchi — Full-Stack Product Engineer building products users love. Founder, hacker, and rapid prototyper.",
  },
  nav: {
    home: "Home",
    projects: "Projects",
  ...
  skills: {
    ...
    items: {
      ...
      Scala: "In University",
      C: "In University",
      Solidity: "Self-taught for personal projects",
      "Pine Script": "Freelancing on Fiverr",
      HTML: "In University, hackathons and perfected while working in Builders Garden",
      ...
      EVM: "Self taught, during hackathons and perfected while working in Builders Garden",
